...
// Adapted to .NET Core 3.1 by Sergei Lopatin under the Apache 2.0 License
//----------------------------------------------------------------------------
...
namespace FSharp.Charting.Core
    ...
    *)
        ...
        type ChartControl(srcChart:GenericChart) as self = 
            ...
            do
              ...
              let miCopy    = new ToolStripMenuItem("&Copy Image to Clipboard"       , null, null, Keys.Control|||Keys.C)
              let miCopyEmf = new ToolStripMenuItem("Copy Image to Clipboard as &EMF", null, null, Keys.Control|||Keys.Shift|||Keys.C)
              let miSave    = new ToolStripMenuItem("&Save Image As.."               , null, null, Keys.Control|||Keys.S)
              let miEdit    = new ToolStripMenuItem("Show Property &Grid"            , null, null, Keys.Control|||Keys.G)
              ...
              menu.Items.AddRange [| for item in [miCopy;miCopyEmf;miSave;miEdit] -> item :> ToolStripItem |]
...
*)
    ...
    *)
            ...
            member ch.ShowChart () =
                let frm = new Form(Visible = true, Width = 700, Height = 500)
