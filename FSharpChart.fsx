...
namespace Samples.FSharp.Charting
    ...
    module ChartTypes = 
        ...
        /// An implementation type used by FSharpChart to create labelled points on chart. This
    ...
    *)
        ...
        let internal mergeDataAndLabelsForXY6 (data:seq<#value * #value * #value * #value * #value * #value * #value>) labels = 
            ...
            | None -> 
                ...
                ChartData.Values(NotifySeq.ignoreReset dataAndLabels, "X", "Y1,Y2,Y3,Y4,Y5,Y6", "")
            | Some labels ->  
                let labels = NotifySeq.notifyOrOnce labels
